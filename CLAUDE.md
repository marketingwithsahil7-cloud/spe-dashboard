...
- **Fee status must key off `for_cycle`, never `paid_date`'s calendar month** — a student paying next month's fee early would otherwise show as "paid" for the wrong month.
